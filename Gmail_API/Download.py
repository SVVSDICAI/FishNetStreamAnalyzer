...
import time
import uuid
from apis.google_apis import create_service
...
if __name__ == '__main__':
	...
	save_location = "C:/Users/mendell_samuel/Desktop/Gmail_API/files/"
		...
		if 'parts' in messageDetailPayload:
			for msgPayload in messageDetailPayload['parts']:
				...
				if 'attachmentId' in body:
					...
					with open(os.path.join(save_location, file_uuid + file_name), 'wb') as _f:
						_f.write(attachment_content)
						print(f'File {file_name}{file_uuid} is saved at {save_location}')
		time.sleep(0.5)